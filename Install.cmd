@echo off
rem Registers LinkPilot with Windows, for your account only. No administrator rights needed.
rem
...
rem so LinkPilot would look installed to them and not exist to Windows.
rem
